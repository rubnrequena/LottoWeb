...
function login_nav(p, arg) {
    $('#login-form').submit(function(e) {
        ...
        socket.sendMessage("login", data, function(e, d) {
            ...
            if (recordar)
                storage.setItem("loto_cmlogin", JSON.stringify(data));
            else
...
function inicio_nav(p, arg) {
    ...
    function balance_pago_click(e) {
        ...
        if (cp <= 3)
            ...
            notificacion('LIMITE DE PAGOS ALCANZADO', 'Estimado usuario, ya has alcanzado el limite de pagos sin confirmar, comuniquese con su administrador.')
    }
...
function sorteoPublicar_nav(p, args) {
    ...
    $('#reporte').submit(function(e) {
        ...
        if (!data.hasOwnProperty("taquillas"))
            data.taquillas = [0];
        ...
        if (ex.length > 0) {
            ...
            socket.sendMessage("publicar", data, function(e, d) {
                socket.sendMessage("sorteos-publicos", {
                    bancaID: bancas.val()
                }, sorteos_publicos);
            })
        }
    ...
    $('#premiar-form').submit(function(e) {
        ...
        socket.sendMessage("sorteo-premiar", data, function(e, d) {
            ...
            if (d.code == 1) {
                ...
                notificacion("SOLICITUD RECHAZADA", " SORTEO #" + data.sorteoID + " SOLICITUD DUPLICADA", 'growl-danger');
            else if (d.code == 8)
                notificacion("SOLICITUD RECHAZADA", " SORTEO #" + data.sorteoID + " SORTEO ABIERTO", 'growl-danger');
        })
    });
...
function bancasBancas_nav(p, args) {
     ...
     */
        ...
        $('.btgl').on("toggle", function(e, act) {
            ...
            act = act == 1 ? 3 : 0;
            socket.sendMessage("usuario-editar", {
                ...
                if (d.code == 1) {
                    ...
                    if (d.hasOwnProperty("nombre"))
                        banca.nombre = d.nombre;
                    if (d.hasOwnProperty("clave"))
                        banca.clave = d.clave;
                } else {
        ...
        $('.bn-remove-req').click(function(e) {
            ...
            if (r === true) {
                socket.sendMessage("banca-remover", {
                    bancaID: bID,
                    papelera: 1
                }, function(e, d) {
                    if (d.code == 1) {
...
function bancasBanca_nav(p, args) {
    if (args && args.length == 1) {
        ...
        editar.submit(function(e) {
            ...
            socket.sendMessage("usuario-editar", data, function(e, d) {
                ...
                if (d.code == 1) {
                    ...
                    notificacion('Error al realizar cambios', '', 'growl-danger');
            });
        });
        var multiplo = 0;
        ...
        clave.submit(function(e) {
            ...
            socket.sendMessage("banca-editar", data, function(e, d) {
                ...
                if (d.code == 1) {
                    ...
                    notificacion('Cambio de clave fallido', '', 'growl-danger');
            });
        });
        ...
        socket.sendMessage("usuario-grupos", {
            usuarioID: banca.usuarioID
        }, function(e, d) {
            grupos = d || [];
            updateGrupos();
        ...
        function updateGrupos() {
            ...
            grupos.sort(function(a, b) {
                if (a.papelera < b.papelera)
                    return -1;
                else if (a.papelera > b.papelera)
                    return 1;
                else {
                    if (a.activa < b.activa) {
                        return 1;
                        ...
                        return a.taquillaID - b.taquillaID;
                }
            });
            ...
            $('.btgl').on("toggle", function(e, act) {
                ...
                socket.sendMessage("banca-editar", {
                    bancaID: banca.bancaID,
                    activa: act
                }, function(e, d) {
                    if (d.code == 1) {
                        if (d.hasOwnProperty("activa"))
                            banca.activa = d.activa;
                    } else {
        ...
        function updateComision() {
            ...
            socket.sendMessage('taquilla-comisiones', {
                ...
                if (d) {
                    ...
                    $('.comDL').click(function(e) {
                        ...
                        socket.sendMessage('taquilla-comision-dl', {
                            comID: id
                        }, function(e, d) {
                            updateComision();
                            //optimizar local
...
function bancasPermisos_nav(p, args) {
    ...
    function updateView() {
        ...
        $('.permiso-remover').click(function(e) {
            ...
            socket.sendMessage("permiso-remove", {
                meta: id
            }, function(e, d) {
                if (d > 0) {
                    ...
                    notificacion("ERROR AL REMOVER PERMISO", "", "growl-danger");
            });
        });
        var toggles = $('.toggle');
        toggles.each(function(index) {
        ...
        toggles.on("toggle", function(e, act) {
            var id = $(e.target).data('target');
            socket.sendMessage("permiso-update", {
                meta: id,
                valor: act
            }, function(e, d) {
                if (d > 0)
                    ...
                    notificacion("ERROR AL CAMBIAR PERMISO", "", "growl-danger");
            })
        });
    }
}
...
function bancasGrupo_nav(p, args) {
    if (args && args.length == 1) {
        ...
        editar.submit(function(e) {
            ...
            socket.sendMessage("banca-editar", data, function(e, d) {
                ...
                if (d.code == 1) {
                    ...
                    if (d.hasOwnProperty("nombre"))
                        banca.nombre = d.nombre;
                    if (d.hasOwnProperty("comision"))
                        banca.comision = d.comision;
                    if (d.hasOwnProperty("usuario"))
                        banca.usuario = d.usuario;
                } else
                    notificacion('Error al realizar cambios', '', 'growl-danger');
            });
        });
        ...
        socket.sendMessage("banca-grupo", {
            bancaID: args[0]
        }, function(e, d) {
            banca = d;
            formSet(editar, banca, function(val, field) {
            ...
            else if (banca.comision > 0)
                $('#radioRecogedor').trigger('click');
            else if (banca.comision < 0)
                $('#radioReventa').trigger('click');
        ...
        function updateTaquillas() {
            ...
            toggles.on("toggle", function(e, act) {
                ...
                socket.sendMessage("taquilla-editar", {
            ...
            fingerlock.on("toggle", function(e, act) {
                var id = $(e.target).data('target');
                var taquilla = findBy("taquillaID", id, taquillas);
                socket.sendMessage("taquilla-flock", {
                    taquillaID: taquilla.taquillaID,
                    activa: act
                }, function(e, d) {
                    if (d.ok === 1)
            ...
            $('.fingerclear').click(function(e) {
                ...
                socket.sendMessage("taquilla-fpclear", {
                    taquillaID: id,
                    usuarioID: banca.usuarioID
                }, function(e, d) {
                    if (d.ok === 1) {
            ...
            $('.bn-remove-req').click(function(e) {
                ...
                if (r === true) {
                    socket.sendMessage("taquilla-remover", {
                        taquillaID: tID,
                        papelera: 1
                    }, function(e, d) {
                        if (d.code == 1) {
        ...
        remTaqI.click(function() {
            ...
            if (r === true)
                removerTaquilla(taqs[i].taquillaID);
        ...
        if (dBanca.val() == data.uID) {
            ...
            socket.sendMessage("transferir-grupo", data, function(e, d) {
                if (d > 0) {
                    ...
                    notificacion("TRANFERENCIA FALLIDA", "Comuniquese con el administrador");
            })
        }
    })
        ...
        if (data.desde == data.hasta) {
            ...
            socket.sendMessage("transferir", {
                ...
                if (d > 0) {
                    ...
                    if (d == 2)
                        m += '</br>- Ventas y reportes transferidos con exito.';
                    notificacion("TRANSFERENCIA EXITOSA", m);
                } else
                    notificacion("TRANFERENCIA FALLIDA", "Comuniquese con el administrador");
            })
    ...
    var help = {
        ...
        srt: function(id) {
            if (id == 0)
                ...
                return '<a href="#sorteo|' + id + '">#' + padding(id, 5) + '</a>';
        }
    };
    var data;
    var sDia;
...
function reporteGeneral_nav(p, args) {
    ...
    $('#reporte').submit(function(e) {
        ...
        socket.sendMessage("reporte-general", {
            s: fdata,
            g: grp.val()
        }, function(e, d) {
            formLock(f, false);
...
function reporteBanca_nav(p, args) {
    ...
    $('#reporte').submit(function(e) {
        ...
        var f = formLock(this);
        $('#pheader').html(jsrender($('#rd-prtaq'), fdata, hlp));
        socket.sendMessage("reporte-banca", {
            s: fdata,
            g: grp.val()
        }, function(e, d) {
            formLock(f, false);
...
function reporteRecogedor_nav(p, args) {
    ...
    $('#reporte').submit(function(e) {
        ...
        var f = formLock(this);
        $('#pheader').html(jsrender($('#rd-prtaq'), fdata, hlp));
        socket.sendMessage("reporte-recogedor", {
            s: fdata,
            g: grp.val()
        }, function(e, d) {
            formLock(f, false);
...
function reporteVentas_nav(p, args) {
    ...
    $('#reporte').submit(function(e) {
        ...
        socket.sendMessage("reporte-ventas", data, function(e, d) {
            formLock(f, false);
            if (!d.last)
                socket.addListener('reporte-ventas', prefetch);
...
function reporteCobros_nav(p, args) {
    ...
    reporte.submit(function(e) {
        ...
        socket.sendMessage("reporte-cobros", {
            s: data,
            g: grp
        }, function(e, d) {
            formLock(f, false);
            ...
            function lazyLoad() {
                if (lazy.length > 0) {
                    ...
                    gdata.uid = id;
                    socket.sendMessage("reporte-subcobros", {
                        s: gdata,
                        g: 3
                    }, function(e, dgr) {
                        var cm2 = 0;
    ...
    function cbrbal_click(ev) {
        ...
        socket.sendMessage('balance-add', {
            usID: id,
            monto: m,
            desc: d,
            cdo: 1
...
function reporteBalance_nav(p, args) {
    ...
    if (args && args.length > 0) {
        ...
        socket.sendMessage('balance-us', {
            usID: args[0]
        }, function(e, d) {
            if (d.hasOwnProperty("code")) {//vacio
            } else {
                usData = d.bl || [];
                user = d.us;
        ...
        function reporte_pagos(inicio, fin) {
            socket.sendMessage('balance-pagos', {
                'inicio': inicio,
                'fin': fin
            }, function(e, d) {
                d = d || [];
                ...
                if (tipo == "g") {
                    ...
                    socket.sendMessage("banca-editar", {
                        ...
                        if (d.code == 1) {
                            ...
                            notificacion("ERROR", "OCURRIO UN ERROR AL SUSPENDER A " + u.nombre);
                    }
                    );
                } else if (tipo == "u") {
    ...
    $('#bl-remover-registro').click(function() {
        askme('REMOVER REGISTRO', 'Esta opcion le permite borrar el ultimo registro del balance, desea continuar?', {
            ok: function(r) {
                socket.sendMessage('balance-remover', {
                    usID: user.usID
                }, function(e, d) {
                    usData.shift();
...
function smsLeer_nav(p, args) {
    if (args && args.length > 0) {
        ...
        socket.sendMessage("sms-leer", {
            ...
            socket.sendMessage("sms-respuestas", {
                hilo: sms.smsID
            }, function(e, d) {
    ...
    function getLista() {
        socket.sendMessage("usuario-listaSuspender", null, function(e, d) {
            ...
            $('.sprem').click(function(e) {
                ...
                if (c) {
                    socket.sendMessage("usuario-susprem", {
                        sID: id
                    }, function(e, d) {
